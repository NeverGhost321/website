	...
	<tr>
		<td width="150" cellpadding="5" valign="top" align="center" bgcolor="#ff8000">
			...
			<div class="product-item">
				<img src="https://hi-stores.ru/upload/iblock/b85/b85b0542702050d9f99767352c3836f6.jpg">
				<div class="product-list">
				  <h3>Apple iPhone 12 Pro Max 512Gb Pacific Blue</h3>
					<span class="price">₽ 124 485</span>
					<a href="" class="button">В корзину</a>
				</div>
			  </div>

			  <div class="product-item">
				<img src="https://i01.appmifile.com/webfile/globalimg/Cindy/J15SGreen!800x800!85.png">
				<div class="product-list">
				  <h3>xiomi redmi note 9</h3>
			  ...
			  <div class="product-item">
				<img src="https://avatars.mds.yandex.net/get-mpic/7724829/img_id9072206427805885428.jpeg/orig">
				<div class="product-list">
				  <h3>OnePlus 10 Pro 8/128 ГБ USA, nano SIM+eSim, вулканический черный </h3>
					<span class="price">₽ 48 485</span>
					<a href="" class="button">В корзину</a>
				</div>
			  </div>
