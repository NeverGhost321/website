...
<table border="0" width="900" cellpadding="5" cellpadding="0" align="center">
	<tr>
		<td width="150" cellpadding="5" valign="top" align="center" bgcolor="#ff8000">
            <a class="button" href="sample.php">Бытовая техника</a><BR>
				<a class="button" href="krasota.html">Красота и здоровье</a><BR>
    ...
    <div class="form-group position-relative">
        ...
        <input type="text" id="formName" name="formName" class="form-control form-control-lg thick" placeholder="Name">
    </div>
    ...
    <div class="form-group position-relative">
        ...
        <input type="email" id="formEmail" name="formEmail" class="form-control form-control-lg thick" placeholder="E-mail">
    </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO support (name, email, massage) VALUES ('$name', '$email', '$message')";
