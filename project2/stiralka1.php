...
if ($result_product->num_rows > 0) {
    ...
    echo "
        <p align='justify'>
            <img src='https://ru.viomi.com/upload/resize_cache/iblock/28e/zya83rdsbm6f1aewv7e1lhe8lstdiesg/940_940_1/Viomi_Master_2_Pro_Gallery_05.jpg' width='300' height='300' alt='Washing Machine' style='float:left; margin-right:20px;'>
...
?>
                ...
                <table border="1" cellpadding="10" cellspacing="5">
                    ...
                    <tr>
                        ...
                        <td>Модель</td>
                        <td colspan="2">Viomi Master 2 Pro</td>
                    </tr>
                    <tr>
                        <td>Код производителя</td>
                        <td colspan="5">[WD10FT-B6E]</td>
                    </tr>
                    <tr>
                        <td>Вид</td>
                        <td colspan="5">автомат</td>
                    </tr>
                    <tr>
                        <td>Основной цвет</td>
                    ...
                    <tr>
                        <td>Глубина с учетом выступающих элементов</td>
                        <td>58 см</td>
                        <td>Глубина с открытой дверцей</td>
                        <td>105 см</td>
                        <td>Вес</td>
                        <td>65 кг</td>
                    </tr>
                    <tr>
                        <td>Габариты в упаковке (ШxВxГ)</td>
                        <td colspan="3">67x88.8x63 см</td>
