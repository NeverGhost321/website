...
<head>
    ...
    <link rel="stylesheet" href="tovar2.css">
	<style>
...
<body>
    ...
    <main class="main">
        ...
        <div class="container">
            <h1>RENAULT LOGAN STEPWAY</h1>
            <td><img width="250" align="center" src="https://www.major-renault.ru/files/resources/28965_medium.jpg" alt=" MAJOR AUTO RENAULT"></td>
            <div class="page-block">
                <b>КРОСС-СЕДАН RENAULT LOGAN STEPWAY</b>
                <p>Для тех, кто предпочитает комфорт седана, при этом хочет получить больше свободы в передвижениях. В данной модели легендарная надежность встречается с ярким стилем и характером кроссовера! Это идеальный городской автомобиль на страже вашего комфорта!</p>
            </div>
        </div>
