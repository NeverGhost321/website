...
<head>
    ...
    <link rel="stylesheet" href="tovar5.css">
	<style>
...
<body>
                        ...
                        <table cellpadding="5" width="100%">
                            <tr>
                                <div class="wave-group">
                                    ...
                                    <span class="bar"></span>
                                    <label class="label">
                                        <span class="label-char" style="--index: 0">Л</span>
                                        <span class="label-char" style="--index: 1">о</span>
                                        <span class="label-char" style="--index: 2">г</span>
                                        <span class="label-char" style="--index: 3">и</span>
                                        <span class="label-char" style="--index: 4">н</span>
                                    </label>
                                </div>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="voiti" align="right">
                                    <a>
                                        <button onclick=window.location.href='voiti.php'>
                                            Вход
    ...
    <main class="main">
        ...
        <div class="container">
            ...
            <td><img width="250" align="center" src="https://www.major-renault.ru/files/resources/14360_medium.jpg  " alt=" MAJOR AUTO RENAULT"></td>
            <div class="page-block">
                <b>Отвечает требованиям профессионалов.</b>
                <p>Master мгновенно выделяется на фоне остальных благодаря высокой линии капота и хромированной решетке радиатора, а динамичность образу придают характерные С-образные светодиодные дневные ходовые огни. Коммерческий автомобиль Renault Master разработан для профессионалов и станет идеальным партнером в вашем бизнесе.</p>
            </div>
        </div>
        <table class="mytabl" border="1" cellpadding="1" cellspacing="1" align="center">
            <tbody>
                <tr>
