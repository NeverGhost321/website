...
<body>
    ...
    <main class="main">
        ...
        <div class="container">
            <h1>RENAULT KAPTUR</h1>
            <td><img width="250" align="center" src="https://www.major-renault.ru/files/resources/28952_medium.jpg" alt=" MAJOR AUTO RENAULT"></td>
            <div class="page-block">
                <b>Кто сказал, что нельзя измениться внутри...</b>
                <p>Мягкие и качественные материалы отделки интерьера создают ощущение уюта, а новое расположение клавиш управления интуитивно понятно и делает исполь зование всех функций автомобиля в пути еще удобнее.</p>
            </div>
        </div>
