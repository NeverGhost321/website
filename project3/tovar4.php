...
<body>
    ...
    <main class="main">
        ...
        <div class="container">
            ...
            <td><img width="250" align="center" src="https://www.major-renault.ru/files/resources/28971_medium.jpg" alt=" MAJOR AUTO RENAULT"></td>
            <div class="page-block">
                <b>Позвольте себе кроссовер!</b>
                <p>Автомобиль для тех, кто не боится проявить неудержимый характер и страсть к приключениям. С ним вы сможете покорить самые заветные вершины и почувствуете свободу. Когда города мало — Renault Sandero Stepway! </p>
            </div>
        </div>
