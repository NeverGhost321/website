...
<head>
    ...
    <link rel="stylesheet" href="tovar1.css">
	<style>
...
<body>
    ...
    <main class="main">
        ...
        <div class="container">
            <h1>RENAULT LOGAN</h1>
            <td><img width="250" align="center" src="https://www.major-renault.ru/files/resources/28962_medium.jpg" alt=" MAJOR AUTO RENAULT"></td>
            <div class="page-block">
                <b>Привычная надежность в новом исполнении.</b>
                <p>Мы взяли все самое ценное — комфорт, безопасность и практичность — и дополнили новым динамичным дизайном, светодиодной оптикой и современными технологиями.</p>
            </div>
        </div>
